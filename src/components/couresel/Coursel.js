    ...
    <div  className="coursel">
      <Carousel interval={9000} indicators={true}>
        ...
        <Carousel.Item>
          <img
            className="image"
            src="https://images.unsplash.com/photo-1469474968028-56623f02e42e?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=753&q=80"
            alt="Second slide"
          />
